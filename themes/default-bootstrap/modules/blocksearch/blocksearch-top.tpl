...
<div id="search_block_top" class="col-xs-3 col-md-4 col-lg-3 clearfix col-lg-offset-1 header__col header__col_search">
	<button class="search_block_top-mobile-btn"></button>
