                                    ...
                                    <ul class="tires-calc-col__list">
                                        {foreach from=$feature.values item=value name=value}
                                            <li class="tires-calc-col__item">
                                                <input type="radio" name="feature_{$smarty.foreach.features.index}"
                                                       id="feature_{$smarty.foreach.features.index}_{$smarty.foreach.value.index}"
                                                       class="not_uniform tires-calc-col__input" value="{$value.feature_url}-{$value.url_name}">
                                                <label for="feature_{$smarty.foreach.features.index}_{$smarty.foreach.value.index}"
                                                       class="tires-calc-col__label"> <span class="tires-calc-col__icon"><i
                                                                class="icon feature_{$smarty.foreach.features.index}"></i></span> {$value.value}</label>
                                            </li>
                                        {/foreach}
                                    </ul>
                                </div>
